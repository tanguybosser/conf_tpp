...
def load_data(args: Namespace) -> dict:
    if args.combine_training_cal:
        size_seeds = {
            "train": [args.train_size+args.cal_size, args.seed],
            "val": [args.val_size, args.seed + args.train_size],
            "cal":[args.cal_size, args.seed + args.train_size + args.val_size],
            "test": [args.test_size, args.seed + args.train_size + args.cal_size + args.val_size]}
    else:
        size_seeds = {
    ...
    #dataset sizes are already fixed if loaded dataset.
    datasets = {
