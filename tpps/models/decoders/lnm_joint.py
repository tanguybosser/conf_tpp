...
class LogNormalMixtureDecoderJoint(VariableHistoryDecoder):
    ...
    def __init__(
        ...
        super(LogNormalMixtureDecoderJoint, self).__init__(
            name="lnm-joint",
    ...
    def forward(
        ...
        f = f_k * p_m #[B,T,K] #Joint distribution 
        f = th.sum(f, dim=-1)

        cum_f = cum_f_k * p_m 
        cum_f = th.sum(cum_f, dim=-1) #[B,T]
